                    ...
                    <div class="row setup-content" id="step-2">
                        <div class="col-sm-12">
                          ...
                          <div class="form-group">
                            ...
                            <!-- Pwd input-->
                          <div class="form-group">
                            <label class="col-sm-2 control-label" for="textinput">비밀번호</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                          ...
                          <div class="form-group">
                            ...
                            <!-- Gender input-->
                          <div class="form-group">
                            <label class="col-sm-2 control-label" for="textinput">성별</label>
                            <div class="col-sm-10">
                                <div class="input-group">
		...
		<div class="btn-group" data-toggle="buttons">
			...
			<label class="btn btn-danger"  style="background-color:rgba(255, 136, 132, 0.94) ; "  >
				...
				<span class="glyphicon ">W</span>
                            ...
                            <!-- birth input-->
                          <div class="form-group">
                            <label class="col-sm-2 control-label" for="textinput">생년월일</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                            ...
                            <!-- tel input-->
                          <div class="form-group">
                            <label class="col-sm-2 control-label" for="textinput">전화번호</label>
                            <div class="col-sm-10">
                                <div class="input-group">
                          ...
                          <!-- Text input-->
                          <div class="form-group">
                            <label class="col-sm-2 control-label" for="textinput">카드번호</label>
                            <div class="col-sm-4">
                                <div class="input-group">
                            ...
                            <label class="col-sm-2 control-label" for="textinput">결제번호</label>
                            <div class="col-sm-4">
                                <div class="input-group">
