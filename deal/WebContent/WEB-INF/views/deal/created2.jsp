...
<head>
    ...
    <link href="<%=cp%>/res/template/fonts/css/font-awesome.min.css" rel="stylesheet">
    ...
    <link href="<%=cp%>/res/template/css/editor/external/google-code-prettify/prettify.css" rel="stylesheet">
    <link href="<%=cp%>/res/template/css/editor/index.css" rel="stylesheet">
    <!-- select2 -->
    <link href="<%=cp%>/res/template/css/select/select2.min.css" rel="stylesheet">
    <!-- switchery -->
    <link rel="stylesheet" href="<%=cp%>/res/template/css/switchery/switchery.min.css" />
 ...
 <script src="<%=cp%>/res/template/js/bootstrap.min.js"></script>
  <script src="<%=cp%>/res/template/js/icheck/icheck.min.js"></script>
        ...
        <!-- switchery -->
        <script src="<%=cp%>/res/template/js/switchery/switchery.min.js"></script>
